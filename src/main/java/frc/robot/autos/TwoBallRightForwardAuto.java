...
public class TwoBallRightForwardAuto extends SequentialCommandGroup {
  public TwoBallRightForwardAuto(SwerveSubsystem s_Swerve){
    ...
    Trajectory tarjectoryPart2 =
        TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(0, Units.inchesToMeters(-40), new Rotation2d(Units.degreesToRadians(-90))),
            // Pass through these two interior waypoints, making an 's' curve path
            List.of(new Translation2d(Units.inchesToMeters(-10), Units.inchesToMeters(-35)), 

                    new Translation2d(Units.inchesToMeters(10), Units.inchesToMeters(-30)),

                    new Translation2d(Units.inchesToMeters(-10), Units.inchesToMeters(-35))),
            
            
            // End 3 meters straight ahead of where we started, facing forward
            new Pose2d(Units.inchesToMeters(0), Units.inchesToMeters(-30), new Rotation2d(Units.degreesToRadians(90))),
            config);
